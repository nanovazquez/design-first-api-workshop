...
1. The first step for this is to configure the code generation options in SwaggerHub.. Open a new browser window and navigate into [SwaggerHub](https://app.swaggerhub.com). Choose the **NodeConf API** you created in the previous exercise.
...
1. A modal window will appear. In its left pane, search for **typescript-fetch** in the **Clients** and select it.
1. In the **client / typescript-fetch** window on the right, enter the following values:
